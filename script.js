...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const certificates = [
        ...
        { name: 'Fluência - Fundamentos da Inteligência Artificial', image: 'Certificados_img/Certificado_FLUÊNCIA - FUNDAMENTOS DA INTELIGÊNCIA ARTIFICIA-1.png' },
        { name: 'Desvendando o E-Social', image: 'Certificados_img/Certificado_Desvendando o ES-1.png' },
        { name: 'Empreender SENAI', image: 'Certificados_img/Certificado_Empreender SENA-1.png' },
        { name: 'Desvendando a Indústria 4.0', image: 'Certificados_img/Certificado_Desvendando a Indústria 4.-1.png' },
        { name: 'Competência Transversal - Segurança no Trabalho', image: 'Certificados_img/Certificado_Competência Transversal - Segurança no Trabalh (2)-1.png' },
        { name: 'Desvendando o 5G', image: 'Certificados_img/Certificado_Desvendando o 5g-1.png' },
        { name: 'Economia Circular', image: 'Certificados_img/Certificado_Economia Circula (1)-1.png' },
        { name: 'Privacidade e Proteção de Dados (LGPD)', image: 'Certificados_img/Certificado_Privacidade e Proteção de Dados (LGPD (1)-1.png' },
        { name: 'WEB 3.0', image: 'Certificados_img/Certificado_WEB 3.-1.png' },
        { name: 'Introdução ao Bootcamp - Back-end com Python', image: 'Certificados_img/Introdução ao Bootcamp - Back - end - com Python-1.png' },
        { name: 'Ambiente de Desenvolvimento e Primeiros Passos com Python', image: 'Certificados_img/Ambiente de Desenvolvimento e Primeiros Passos com Python-1.png' },
        { name: 'Conhecendo a Linguagem de Programação Python', image: 'Certificados_img/Conhecendo a Linguagem de Programação Python-1.png' },
        { name: 'Conhecendo Tuplas em Python', image: 'Certificados_img/Conhecendo Tuplas em Python-1.png' },
        { name: 'Decoradores, Iteradores e Geradores com Python', image: 'Certificados_img/Decoradores, Iteradores e Geradores com Python-1.png' },
        ...
        { name: 'Aprendendo a Utilizar Dicionários em Python', image: 'Certificados_img/Aprendendo a Utilizar Dicionários em Python-1.png' },
        ...
        { name: 'Aplicando Encapsulamento em Python', image: 'Certificados_img/Aplicando Encapsulamento em Python-1.png' },
        { name: 'Aprendendo o Conceito de Herança com Python', image: 'Certificados_img/Aprendendo o Conceito de Herança com Python-1.png' },
        { name: 'Boas Práticas Para APIs RESTful', image: 'Certificados_img/Boas Práticas Para APIs RESTful-1.png' },
        { name: 'Conhecendo Polimorfismo em Python', image: 'Certificados_img/Conhecendo Polimorfismo em Python-1.png' },
        ...
        { name: 'Autenticação e Autorização em FastAPI', image: 'Certificados_img/Autenticação e Autorização em FastAPI-1.png' },
        { name: 'Bases de Prompt Engineering para o GitHub Copilot', image: 'Certificados_img/Bases de Prompt Engineering para o GitHub Copilot-1.png' },
        { name: 'Boas Práticas para APIs RESTful Assíncronas com FastAPI', image: 'Certificados_img/Boas Práticas para APIs RESTful Assíncronas com FastAPI-1.png' },
        { name: 'Configurando e Usando o GitHub Copilot', image: 'Certificados_img/Configurando e Usando o GitHub Copilot-1.png' },
        { name: 'Conhecendo o GitHub Copilot-Aumentando sua Produtividade na Programação', image: 'Certificados_img/Conhecendo o GitHub Copilot-Aumentando sua Produtividade na Programação-1.png' },
        { name: 'Criando sua API Bancária Assíncrona com FastAPI', image: 'Certificados_img/Criando sua API Bancária Assíncrona com FastAPI-1.png' },
